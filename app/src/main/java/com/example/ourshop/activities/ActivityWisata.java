...
public class ActivityWisata extends AppCompatActivity implements WisataAdapter.onSelectData {
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(ActivityWisata.this,
    ...
    private void showWisata() {
        kulinerAdapter = new WisataAdapter(ActivityWisata.this, modelKuliner, this);
        rvWisata.setAdapter(kulinerAdapter);
    }

    @Override
    public void onSelected(ModelWisata modelWisata) {
        Intent intent = new Intent(ActivityWisata.this, ActivityDetailWisata.class);
